...
public enum ResultCodeEnum {
    ...
    public static ResultCodeEnum getResultCodeEnum(int code) {
        Optional<ResultCodeEnum> commonDataStatusEnum = Arrays.stream(ResultCodeEnum.values()).filter(codeEnum -> codeEnum.getCode() == code).findFirst();
        return commonDataStatusEnum.orElse(null);
    }
